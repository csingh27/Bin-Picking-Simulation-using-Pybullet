...
d.ROBOT_URDF_MODEL_SUCTION=os.path.join(FILE_PATH,"Models/Robots/UR5/urdf/ur5e.urdf")
...
def motors_arm(sliders,choice,joint_grasp):
    while True: 
	    ...
	    im.save(path, '')
            ...
            init_poses = [0, -d.math.pi/2, -d.math.pi/2, -d.math.pi/2, -d.math.pi/2, 0]
            if choice==0:
...
def grasp_user_input():
                ...
                while True:
                    ...
                    if num in range(1,6):
                        ...
                        p.addUserDebugLine(end_pos[7],end_pos[8])
                        ...
                        ori8eul=p.getEulerFromQuaternion(end_ori[8])
...
def grasp_control(position,quaternion):
        ...
        #rest_poses = [0, -math.pi/2, -math.pi/2, -math.pi/2, -math.pi/2, 0,0,0,0,0,0,0]
        rest_poses = [0, d.math.pi/2, 0, -d.math.pi/2, -d.math.pi/2, 0]
